...
std::string default_reskey(int iNumber, std::optional<uint32_t> base36Number)
{
    if (!base36Number.has_value() || base36Number == NoBase36)
    {
...
{
    return default_reskey(resource_id.GetNumber(), resource_id.GetBase36());
}